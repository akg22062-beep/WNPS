  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        <div className="bg-white p-4 rounded-xl border border-[#E2E8E2] shadow-xs">
          <div className="flex items-center justify-between mb-1">
            <span className="text-xs font-bold uppercase text-[#6B7280]">Total Enrolled</span>
            <span className="p-1.5 bg-[#89A894]/15 text-[#4F6D7A] rounded-lg">
        ...
        <div className="bg-white p-4 rounded-xl border border-[#E2E8E2] shadow-xs">
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="p-1.5 bg-[#F2F4F2] text-[#4F6D7A] rounded-lg">
        ...
        <div className="bg-white p-4 rounded-xl border border-[#89A894]/40 bg-[#89A894]/5 shadow-xs">
          <div className="flex items-center justify-between mb-1">
            <span className="text-xs font-bold uppercase text-[#4F6D7A]">Total Collected</span>
            <span className="p-1.5 bg-[#89A894]/20 text-[#89A894] rounded-lg">
              <CheckCircle2 className="w-4 h-4" />
            </span>
          </div>
          <div className="text-2xl font-black text-[#89A894] font-mono">
        ...
        <div className="bg-white p-4 rounded-xl border border-[#D68A6E]/40 bg-[#D68A6E]/5 shadow-xs">
          <div className="flex items-center justify-between mb-1">
            <span className="text-xs font-bold uppercase text-[#D68A6E]">Pending Balance</span>
            <span className="p-1.5 bg-[#D68A6E]/15 text-[#D68A6E] rounded-lg">
              <AlertCircle className="w-4 h-4" />
            </span>
          </div>
          <div className="text-2xl font-black text-[#D68A6E] font-mono">
            {formatCurrency(stats.totalPending)}
          </div>
          <div className="text-[11px] text-[#D68A6E]/90 font-medium mt-1">
