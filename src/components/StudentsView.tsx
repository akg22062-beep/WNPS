        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 self-start sm:self-auto">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-[#F2F4F2] hover:bg-[#E2E8E2] text-[#4F6D7A] font-bold rounded-lg text-xs border border-[#E2E8E2] transition-colors cursor-pointer"
            >
